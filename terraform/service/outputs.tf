...
# # Lambda Functions
# ##################
# output "lambda_acronyms_get_arn" {
#   description = "The ARN of the Lambda Function"
#   value       = module.lambda_account_get.lambda_function_arn
# }

# output "lambda_acronyms_get_invoke_arn" {
#   description = "The Invoke ARN of the Lambda Function"
#   value       = module.lambda_account_get.lambda_function_invoke_arn
# }

# output "lambda_acronyms_get_name" {
#   description = "The name of the Lambda Function"
#   value       = module.lambda_account_get.lambda_function_name
# }

# output "lambda_function_qualified_arn" {
#   description = "The ARN identifying your Lambda Function Version"
#   value       = module.lambda_account_get.lambda_function_qualified_arn
# }

# output "lambda_function_version" {
#   description = "Latest published version of Lambda Function"
#   value       = module.lambda_account_get.lambda_function_version
# }
